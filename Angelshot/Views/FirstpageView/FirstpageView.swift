...
struct FirstpageView: View {
    @StateObject var firstpageViewModel = FirstpageViewModel()
            ...
            VStack {
                ZStack {
                    VStack {
                        ...
                        Text(StringConstants.kMsgWeProtectYou)
                            ...
                            .padding(.horizontal, getRelativeWidth(51.0))
                        Button(action: {
                            firstpageViewModel.nextScreen = "SignupView"
                        }, label: {
                            HStack(spacing: 0) {
                        ...
                        HStack {
                            ...
                            Button(action: {
                                firstpageViewModel.nextScreen = "LoginView"
                            }, label: {
                                HStack(spacing: 0) {
                        ...
                        ZStack(alignment: .center) {
                            ...
                            Image("img_hug1")
                                ...
                                .frame(width: getRelativeWidth(362.0),
                                       height: getRelativeHeight(393.0), alignment: .center)
                                .scaledToFit()
                                .clipped()
                ...
                Group {
                    NavigationLink(destination: SignupView(),
                                   tag: "SignupView",
                                   selection: $firstpageViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
