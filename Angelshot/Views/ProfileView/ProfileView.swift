...
struct ProfileView: View {
    ...
    var body: some View {
        NavigationView {
                        ...
                        Group {
                            ...
                            HStack {
                                ...
                                Text(StringConstants.kLblLogout)
                                    ...
                                    .padding(.leading, getRelativeWidth(16.0))
                                    .onTapGesture {
                                        profileViewModel.nextScreen = "LoginView"
                                    }
                            }
            ...
            .background(ColorConstants.WhiteA700)
            .ignoresSafeArea()
            .actionSheet(isPresented: $profileViewModel.isActionSheetShow, content: {
                ActionSheet(title: Text("Choose"), buttons: [
                    .default(Text("Camera"), action: {
                        if UIImagePickerController.isSourceTypeAvailable(.camera) {
                            profileViewModel.imagePickerSource = .camera
                            profileViewModel.isImagePickerShow = true
                        } else {
                            profileViewModel.showAlert("Error", "Camera is not available!")
                        }
                    }),
                    .default(Text("Photo Library"), action: {
                        profileViewModel.imagePickerSource = .photoLibrary
                        profileViewModel.isImagePickerShow = true
                    }),
                    .destructive(Text("Cancel"))
                ])
            })
            .sheet(isPresented: $profileViewModel.isImagePickerShow, content: {
                MediaPicker(sourceType: profileViewModel.imagePickerSource,
