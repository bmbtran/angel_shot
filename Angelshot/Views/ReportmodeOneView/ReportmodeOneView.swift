            ...
            VStack {
                        ...
                        ScrollView(.vertical, showsIndicators: false) {
                            VStack {
                                Group {
                                    ...
                                    HStack {
                                        TextField("",
                                                  text: $reportmodeOneViewModel.rectangle240Text)
                                            .padding()
                                    }
                                ...
                                Group {
                                    ...
                                    Text(StringConstants.kLblReturnToMenu)
                                        ...
                                        .padding(.horizontal, getRelativeWidth(17.0))
                                        .onTapGesture {
                                            reportmodeOneViewModel.nextScreen = "Emergency1View"
                                        }
                                }
                            }
                ...
                Group {
                    NavigationLink(destination: Emergency1View(),
                                   tag: "Emergency1View",
                                   selection: $reportmodeOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
