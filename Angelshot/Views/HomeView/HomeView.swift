            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    VStack(alignment: .trailing, spacing: 0) {
                                ...
                                ScrollView(.vertical, showsIndicators: false) {
                                    LazyVStack {
                                        ForEach(0 ... 1, id: \.self) { index in
                                            RowmakeafakecalCell(fakecallClick: {
                            ...
                            HStack {
                                VStack(alignment: .leading, spacing: 0) {
                                    Text(StringConstants.kLblSOSMode)
                                        .font(FontScheme
                                            .kInterExtraBold(size: getRelativeHeight(20.0)))
                                        .fontWeight(.heavy)
                                    ...
                                    Text(StringConstants.kMsgThisWillTrigg)
                                        .font(FontScheme
                                            .kInterMedium(size: getRelativeHeight(12.0)))
                                        .fontWeight(.medium)
                                        .foregroundColor(ColorConstants.WhiteA700)
                                        .minimumScaleFactor(0.5)
                                        .multilineTextAlignment(.leading)
                                ...
                                .frame(width: getRelativeWidth(213.0),
                                       height: getRelativeHeight(59.0), alignment: .top)
                        ...
                        .frame(width: getRelativeWidth(372.0), height: getRelativeHeight(541.0),
                               alignment: .trailing)
                        .padding(.leading)
                        .padding(.leading)
                        Text("tabbar")
