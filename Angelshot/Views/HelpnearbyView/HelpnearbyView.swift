...
struct HelpnearbyView: View {
    ...
    var body: some View {
        NavigationView {
            VStack {
                VStack {
                    VStack(alignment: .leading, spacing: 0) {
                        Text(StringConstants.kLblBack)
                            ...
                            .padding(.trailing)
                            .onTapGesture {
                                helpnearbyViewModel.nextScreen = "HomeView"
                            }
                    }
                    ...
                    VStack {
                        ...
                        VStack {
                            Button(action: {
                                helpnearbyViewModel.isHelpnearbyreceivedViewShow = true
                            }, label: {
                                HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: HomeView(),
                                   tag: "HomeView",
                                   selection: $helpnearbyViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
            ...
            .background(ColorConstants.WhiteA700)
            .ignoresSafeArea()
            .customDialog(isShowing: $helpnearbyViewModel.isHelpnearbyreceivedViewShow) {
                HelpnearbyreceivedView(helpnearbyreceivedViewModel: HelpnearbyreceivedViewModel(_isOpen: $helpnearbyViewModel
                        .isHelpnearbyreceivedViewShow))
            } onTapOutside: { value in
                if value {
                    helpnearbyViewModel.isHelpnearbyreceivedViewShow = false
                }
            }
            .hideNavigationBar()
        }
